...
nameList = list(df.iloc[:,0]) #Gets the info in the first column
preferredList = list(df.iloc[:,1]) #Gets the info in the second column
blackList = list(df.iloc[:,2]) #Gets the info in the third column
personalityList = list(df.iloc[:,3]) #Gets the info in the fourth column
genderList = list(df.iloc[:,4]) #Gets the info in the fifth column
skillsList = list(df.iloc[:,5]) #Gets the info in the sixth column
